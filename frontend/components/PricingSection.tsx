...
const plans: Plan[] = [
  {
    ...
    description: '1 cámara Hikvision ColorVu WiFi 4MP',
    features: [
      '1 cámara ColorVu WiFi',
      'Visión nocturna en color',
      'Monitoreo desde tu celular',
      'Instalación incluida',
      'Garantía 30 días instalación',
    ],
    waMessage:
      'Hola, me interesa el Plan Básico de cámaras (1 cámara). ¿Pueden cotizarme?',
  },
  {
    name: 'Plan Estándar',
    price: 'desde $8,900 MXN',
    description: '2 cámaras Hikvision ColorVu WiFi 4MP',
    features: [
      '2 cámaras ColorVu WiFi',
      'Cobertura interior + exterior',
      'Visión nocturna en color',
      'App configurada en tu teléfono',
      'Monitoreo desde tu celular',
      'Garantía 30 días instalación',
    ],
    waMessage:
      'Hola, me interesa el Plan Estándar de cámaras (2 cámaras). ¿Pueden cotizarme?',
    featured: true,
  },
  {
    name: 'Plan Premium',
    price: 'desde $14,500 MXN',
    description: '3 cámaras + Grabador NVR + Disco Duro 1TB',
    features: [
      '3 cámaras ColorVu WiFi',
      'Grabador NVR incluido',
      'Almacenamiento local 1TB',
      'Grabación 24/7',
      'App configurada en tu teléfono',
      'Garantía 6 meses equipo + instalación',
    ],
    waMessage:
      'Hola, me interesa el Plan Premium de cámaras (3 cámaras + NVR). ¿Pueden cotizarme?',
  },
];
...
const extraServices: ExtraService[] = [
  {
    ...
    price: 'desde $450 MXN',
    description:
      'Limpieza interna, pasta térmica, optimización y antivirus. Con garantía 30 días.',
  },
  {
    title: 'Configuración de red',
    price: 'desde $1,200 MXN',
    description:
      'Router, WiFi, cobertura total. Servicio a domicilio en Chilpancingo.',
  },
];
