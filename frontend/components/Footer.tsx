        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="w-10 h-10 bg-securytech-azul-destacado hover:bg-securytech-dorado hover:text-securytech-azul rounded-lg flex items-center justify-center transition-colors duration-200"
                aria-label="Instagram @seguritech_mx"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-securytech-azul-destacado hover:bg-green-500 hover:text-white rounded-lg flex items-center justify-center transition-colors duration-200"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-white/70 hover:text-securytech-dorado text-sm transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href={`tel:+${PHONE_RAW}`} className="flex items-start gap-2.5 text-white/70 hover:text-securytech-dorado transition-colors">
                  <svg className="w-4 h-4 mt-0.5 text-securytech-dorado flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
              ...
              <li>
                <a href={`mailto:${EMAIL}`} className="flex items-start gap-2.5 text-white/70 hover:text-securytech-dorado transition-colors break-all">
                  <svg className="w-4 h-4 mt-0.5 text-securytech-dorado flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
